--YXCHub Made By Yv_Dev --{ ded Yx#2950 Add me on Discord if you want :grin: }
...
ScreenGui._56.MouseButton1Down:connect(function()
...
ScreenGui._57.MouseButton1Down:connect(function()
...
ScreenGui.UIGradient_57.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(170, 170, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(170, 255, 255))}
...
ScreenGui._58.MouseButton1Down:connect(function()
...
ScreenGui._59.MouseButton1Down:connect(function()
...
ScreenGui._60.MouseButton1Down:connect(function()
...
ScreenGui._61.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/cHmscXYK", true))()
end)

ScreenGui.UICorner_62.Parent = ScreenGui._61
...
ScreenGui._62.MouseButton1Down:connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/1201for/V.G-Hub/main/V.Ghub'))()
end)
...
ScreenGui.UICorner_69.Parent = ScreenGui._68
...
ScreenGui._71.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/YvDev4500/tgriufduiui/main/README.md"))()
end)
...
ScreenGui._73.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/WC7MZ8Ai", true))()
end)
...
ScreenGui.UICorner_76.Parent = ScreenGui._75
...
ScreenGui._76.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/PRypDeUU", true))()
end)
...
ScreenGui.UICorner_83.Parent = ScreenGui._82
...
local function HOYAUMI_fake_script() -- ScreenGui.Frame.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui.Frame)
...
coroutine.wrap(HOYAUMI_fake_script)()
local function UCLGFU_fake_script() -- ScreenGui.Label.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui.Label)
...
coroutine.wrap(UCLGFU_fake_script)()
local function WCDL_fake_script() -- ScreenGui.Close.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui.Close)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Visible = false
	end)
end
coroutine.wrap(WCDL_fake_script)()
local function KGIAFZH_fake_script() -- ScreenGui.OPEN.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui.OPEN)

	local frame = script.Parent.Parent.Frame  --- Change This to the Frame Name
	local open = false
...
coroutine.wrap(KGIAFZH_fake_script)()
local function FRTIBCM_fake_script() -- ScreenGui.OPEN.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui.OPEN)
...
coroutine.wrap(FRTIBCM_fake_script)()
